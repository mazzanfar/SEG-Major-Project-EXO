...
export class Search extends Component {
    ...
    searchWord(keyword) {
        ...
        const foundTopics = this.props.topics.filter((item) =>
            matchRegex.test(item.name.toLowerCase())
        );
        const foundPosts = this.props.posts.filter((item) =>
            matchRegex.test(item.title.toLowerCase())
        );
        const foundDocuments = this.props.documents.filter((item) =>
            matchRegex.test(item.title.toLowerCase())
        );
