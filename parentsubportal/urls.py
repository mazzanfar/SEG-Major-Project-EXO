...
urlpatterns = [
    ...
    path('disability/search', disability_views.search_view.as_view(), name='disability_search'),
    path('disability/detail', disability_views.disability_detail.as_view(), name='disability_detaiil')
]
