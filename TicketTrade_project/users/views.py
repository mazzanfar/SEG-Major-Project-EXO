...
from .forms import UserRegisterForm, UserUpdateForm, ProfileUpdateForm, ChildrenRegisterForm
...
def addChild(request):
    if request.method == 'POST':
        child_form = ChildrenRegisterForm(request.POST, instance=request.user)
