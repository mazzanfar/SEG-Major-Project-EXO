...
from .views import PublicationListView, PublicationDetailView, PublicationCreateView, PublicationUpdateView, PublicationDeleteView
from . import views


urlpatterns = [
    path('', PublicationListView.as_view(), name='store-home'),
    ...
    path('posts/', views.newest_posts, name='store-pub')
]
